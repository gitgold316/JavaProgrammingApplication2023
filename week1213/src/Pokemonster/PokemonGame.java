        ...
        try{
            ...
            while(true){
                ...
                if(menu == 1){
                    ...
                    // Consumer 사용
                    Consumer<Pokemon> healPostion = pokemon -> {
                        pokemon.setHp(pokemon.getHp() + 30);
                    };
                    healPostion.accept(player);
                    // Function 사용
//                    Function<Integer, Integer> healPostion = hp -> hp + 30;
//                    int newHp = healPostion.apply(player.getHp());
                    //Operator 사용
//                    UnaryOperator<Integer> healPostion = hp -> hp + 30;
//                    int newHp = healPostion.apply(player.getHp());
//                    player.setHp(newHp);
